import { AppShell, AppShellMain, AppShellNavbar, Button, Divider, NavLink, Stack, Text } from '@mantine/core'
import {
  IconAmbulance,
  IconClipboardText,
  IconHistory,
    ...
    <AppShell navbar={{ width: 240, breakpoint: 'sm' }} padding="md">
      <AppShellNavbar p="md">
        <Stack gap="xs" h="100%" justify="space-between">
          <Stack gap={4}>
            <Text fw={700} size="lg">IMS Ambulancias</Text>
            <Text size="xs" c="dimmed" mb="sm">Centro de Control</Text>
            {NAV_ITEMS.map((item) => (
              <NavLink
                key={item.to}
                component={Link}
