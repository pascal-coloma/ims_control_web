...
export interface AsignarDespachoResponse {
  ...
  despacho_data: {
    ...
    grupo: {
      nombre: string
      personal: { personal_id: number; personal_rut: string; personal_name: string }[]
    }
  }
}
...
export type AmbulanciaEstado = 'disponible' | 'en_despacho' | 'mantencion' | 'fuera_servicio'
...
export type LogTipo = 'atencion' | 'inventario' | 'ambulancia' | 'despacho' | 'grupo' | 'paciente'
