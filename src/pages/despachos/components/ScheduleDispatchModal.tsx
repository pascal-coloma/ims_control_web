...
export function ScheduleDispatchModal({ despachoId, opened, onClose }: ScheduleDispatchModalProps) {
  ...
  return (
    <Modal opened={opened} onClose={handleClose} title={`Programar Despacho #${despachoId}`}>
      <Stack gap="sm">
        <DateTimePicker
        ...
        <Group justify="flex-end">
          ...
          <Button onClick={() => schedule.mutate()} loading={schedule.isPending} disabled={!fecha || !grupoId}>
            Confirmar
          </Button>
        </Group>
      </Stack>
