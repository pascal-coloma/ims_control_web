    ...
    <Center mih="100vh">
      <Card withBorder shadow="sm" radius="md" p="xl" w={380}>
        <Stack gap="md" align="center">
          <div>
            <Title order={2} ta="center">imSystem</Title>
            <Text c="dimmed" ta="center">Control — Acceso operadores</Text>
          </div>

          <AuthStepIndicator step={2} />

          <Text size="sm" ta="center">Ingresa el código de 6 dígitos de tu app de autenticación.</Text>
