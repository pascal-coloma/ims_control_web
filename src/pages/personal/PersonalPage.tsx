...
export function PersonalPage() {
  ...
  return (
    <>
          ...
          <Table.Tbody>
            {(data ?? []).map((person) => (
              <Table.Tr key={person.id}>
                ...
                <Table.Td>
                  <Badge color={person.is_active ? 'green' : 'gray'} variant="light">
      ...
      <AddStaffModal opened={addOpen} onClose={() => setAddOpen(false)} onProvisioned={setProvisioned} />
      <ProvisioningResultModal result={provisioned} onClose={handleProvisioningClose} />
    </>
  )
}
