...
const appId = process.env.VITE_FIREBASE_WEB_APP_ID || env.VITE_FIREBASE_WEB_APP_ID || "";

const template = readFileSync("public/firebase-messaging-sw.template.js", "utf8");
